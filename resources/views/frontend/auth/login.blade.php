...
<head>
    ...
    <title>{{getSetting('site_name')}} - Login</title><!--begin::Primary Meta Tags-->
        ...
        <div class="card-body login-card-body">
            ...
            <form action="{{route('login.submit')}}" method="post">
                ...
                <div class="input-group mb-1">
                    <div class="form-floating"> <input id="loginEmail" type="email" name="email" class="form-control" value="" placeholder=""> <label for="loginEmail">Email</label> </div>
