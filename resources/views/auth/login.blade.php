...
<head>
    ...
    <title>{{getSetting('business_name')}} | Login Page</title><!--begin::Primary Meta Tags-->
...
<div class="login-box">
    <div class="login-logo"> <a href="{{route('home')}}"><b>{{getSetting('business_name')}}</b></a> </div> <!-- /.login-logo -->
