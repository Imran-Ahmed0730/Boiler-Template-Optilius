                                        ...
                                        <div class="mb-3">
                                            <nav>
                                                <div class="nav nav-tabs me-3" id="v-pills-tab" role="tablist" aria-orientation="horizontal">
                                                    <button class="nav-link active" id="en" data-bs-toggle="pill" data-bs-target="#v-pills-en" type="button" role="tab" aria-controls="v-pills-en" aria-selected="true">English</button>
                                                ...
                                                <div class="tab-content w-100 mt-3" id="v-pills-tabContent">
                                                    <!-- English Translation -->
                                                    <div class="tab-pane fade show active" id="v-pills-en" role="tabpanel" aria-labelledby="v-pills-en-tab">
                                                        @php $en_translation = $item['en'] ?? null; @endphp
                                                        <label for="" class="form-label">Value</label>
                                                        <input type="text" name="value_en" value="{{ $en_translation ? $en_translation->value : old('value_en') }}" placeholder="Enter value for English" class="form-control" required>
                                                    </div>
