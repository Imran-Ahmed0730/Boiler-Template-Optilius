<nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
    <div class="container-fluid"> <!--begin::Start Navbar Links-->
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-md-block"> <a href="{{route('home')}}" title="Go to site" class="nav-link"><i class="fa fa-globe"></i></a> </li>
          ...
          <span class="theme-icon-active">
            ...
            <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                    @if(Auth::user()->image != null)
                        <img src="{{asset(Auth::user()->image)}}" class="user-image rounded-circle shadow" alt="User Image">
                    @else
...
{{--                    </li> <!--end::Menu Body--> <!--begin::Menu Footer-->--}}
                    <li class="user-footer"> <a href="{{route('admin.profile.edit')}}" class="btn btn-default btn-flat">Profile</a> <a href="#" onclick="event.preventDefault(); document.getElementById('logoutForm').submit()" class="btn btn-default btn-flat float-end">Sign out</a> </li> <!--end::Menu Footer-->
                </ul>
