...
@section('title')
   @isset($item) Edit @else Add @endisset Frontend Page
@endsection
@section('content')
    <div class="app-content-header"> <!--begin::Container-->
        <div class="container-fluid"> <!--begin::Row-->
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="mb-0">@isset($item) Edit @else Add @endisset Frontend Page</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row g-4">
                    <div class="col-md-12">
                        <div class="card card-primary card-outline mb-4"> <!--begin::Header-->
                            ...
                            <form action="@isset($item){{route('admin.frontend-page.update')}}@else{{route('admin.frontend-page.store')}}@endisset" method="post" enctype="multipart/form-data">
                                @csrf<!--begin::Body-->
